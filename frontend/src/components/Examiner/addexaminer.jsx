...
import {
  Mail, Phone, Building2, BookOpen, GraduationCap, ChevronRight,
  ArrowLeft, CheckCircle, XCircle
} from "lucide-react";
import Sidebar from "../Sidebar";
import Select from "react-select";
import logo from "../../../public/Img/Examinerlogo.png";
    ...
    try {
      ...
      if (response.ok) {
        toast.success('Examiner added successfully!', {
          ...
          style: { background: '#10B981', color: '#FFFFFF', padding: '16px' },
        });
        setTimeout(() => navigate("/viewexaminers"), 2000);
      } else {
        toast.error('Failed to add examiner', { position: 'bottom-right' });
      }
    } catch (error) {
